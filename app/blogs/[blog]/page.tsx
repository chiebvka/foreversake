    ...
    <div className='w-11/12 mx-auto  px-2 '>
        <main className="mt-10">
            <div className="mb-4 md:mb-0 w-full mx-auto relative">
                ...
                <img src="https://images.unsplash.com/photo-1587614387466-0a72ca909e16?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="w-full object-cover lg:rounded h-[28em]" />
            </div>  
            <div className="flex flex-col lg:flex-row lg:space-x-12">
                ...
                <div className=" mt-12 text-foreground text-base md:text-lg justify-normal leading-relaxed w-full ">
                    ...
                    <h2 className="text-2xl text-foreground font-semibold mb-4 mt-4">Uneasy barton seeing remark happen his has</h2>
                ...
                {/* <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
                    <div className="p-4 border-t border-b md:border-2 border-foreground md:rounded">
                    <div className="flex py-2">
                        <img src="https://randomuser.me/api/portraits/men/97.jpg"
                        className="h-10 w-10 rounded-full mr-2 object-cover" />
                        <div>
                        <p className="font-semibold text-foreground text-sm"> Mike Sullivan </p>
                        <p className="font-semibold text-foregroundtext-xs"> Editor </p>
                        </div>
                    </div>
