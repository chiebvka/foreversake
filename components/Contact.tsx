  ...
  return (
    <div className='flex flex-col justify-center w-full text-white'>
      <div className='flex flex-col items-center justify-center gap-8 bg-contact bg-cover bg-no-repeat bg-center h-[60vh]'> 
        ...
        <input 
          className="placeholder:text-yellow-300 border-2 font-semibold bg-transparent w-[80%] p-3 uppercase cursor-pointer rounded-md text-yellow-300 focus:outline-none focus:ring-0" 
          id="email"
          type="email" 
