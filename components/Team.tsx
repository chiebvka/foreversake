  ...
  return (
    <div className="flex flex-col justify-center items-center px-8 sm:px-20  py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div
          key={team.index}
          className="relative border border-primary md:border-0 items-center flex justify-center overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 focus:scale-110 hover:scale-110"
        >
          <img
