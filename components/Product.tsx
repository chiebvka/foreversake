...
import { PopAnimation } from './Motion'
...
const Product = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className='lg:grid grid-cols-2 gap-10 w-full bg-gray-900 bg-opacity-60 rounded-2xl p-8'>
        <div>
          <PopAnimation>
          ...
          <div className='flex flex-col justify-center items-center font-light text-white py-4 px-10 w-50% bg-yellow-200 bg-opacity-60 rounded-2xl mt-14 lg:p-8'>
        ...
        <div className='flex flex-col-reverse lg:flex-col'>
          <div className='flex flex-col justify-center items-center bg-yellow-300 font-light py-4 px-10 w-50% rounded-2xl my-8 lg:p-8'>
          ...
          <div className='flex justify-center items-center w-50% mb-8 py-6 lg:mx-8'>
            <PopAnimation>
              <Image
                src="/how_1.png"
                width={300}
